...
module com.elnurkarimli.javafx_ibb_ecodation {
    ...
    exports com.elnurkarimli.javafx_ibb_ecodation.dao;

    // // Veritabanı bağlantı paketini dış dünyaya açıyoruz. Diğer modüller DB bağlantısını kullanabilir.
    exports com.elnurkarimli.javafx_ibb_ecodation.database;

    // Ana paketi dış dünyaya açıyoruz. Diğer modüller bu paketin içeriğini kullanabilir.
    exports com.elnurkarimli.javafx_ibb_ecodation;
    opens com.elnurkarimli.javafx_ibb_ecodation.utils to javafx.base, lombok, com.google.gson;
